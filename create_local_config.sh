...
python prov_interop/set_yaml_value.py $CONFIG_DIR/harness.yaml test-cases="$PROV_TEST_CASES"
python prov_interop/set_yaml_value.py $CONFIG_DIR/harness.yaml comparators.ProvPyComparator.executable="$PROVPY_COMPARE"
